...
class News_Services{
  ...
  Future<List<Articlesmodle>> getEGNews() async {
    try {
      final Response response = await dio.get(ConstString.Egypt_Genral_News);
  ...
  Future<List<Articlesmodle>> getSUNews() async {
    try {
      final Response response = await dio.get(ConstString.SU_Genral_News);
  ...
  Future<List<Articlesmodle>> getPSNews() async {
    try {
